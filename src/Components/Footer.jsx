...
const Footer = () => {
    return (
        <div className='w-full h-screen flex px-10 py-16 '>
            <div className='w-1/2 h-full flex flex-col justify-between '>
                <div className=' heading  '>
                    <h1 className='text-8xl font-medium	 tracking-tight leading-none font-["Founders_Grotesk"]'>EYE-</h1>
                    <h1 className='text-8xl font-medium tracking-tight leading-none font-["Founders_Grotesk"] '>OPENING</h1>
                </div>
                <div>
            ...
            <div>
                <div className='text-8xl font-bold	 tracking-tight leading-none  tracking-tight leading-none'>
                    <h1 className='text-8xl font-medium	 tracking-tight leading-none font-["Founders_Grotesk"]  tracking-tight leading-none'>PRESENTATIONS</h1>
                </div>
                <div className='dets font["Neue_Montreal"] m-4'>
